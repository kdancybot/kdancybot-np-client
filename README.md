...
1. [Download the latest Release](https://github.com/kdancybot/np-manager/releases/latest)
...
Yes! see [this](https://github.com/kdancybot/np-manager/wiki/GameOverlay)
...
**[Example JSON and a little wiki of it's values](https://github.com/kdancybot/np-manager/wiki/JSON-values)**
...
* [tdeo](https://github.com/tadeokondrak) for the [Memory Signature Scanner](https://github.com/kdancybot/np-manager/tree/master/mem) package
* [omkelderman](https://github.com/omkelderman) for helping out with the [db](https://github.com/kdancybot/np-manager/tree/master/db) package
...
* [KotRik](https://github.com/KotRikD) for making an [OBS Script](https://github.com/kdancybot/np-manager-helpers/blob/master/gosumemory-reader.py) and porting legacy counters
